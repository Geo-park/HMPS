/* ============================================
   HMPS INF — Floating Contact Button v2
   ============================================ */
...
const ARROW_ICON = `<svg class="floating-contact__item-arrow" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="7" y1="17" x2="17" y2="7"/><polyline points="7 7 17 7 17 17"/></svg>`
    ...
    <div class="floating-contact__items" id="floatingItems" role="list">
      ${CONTACT_DATA.map(c => `
        <a href="${c.href}"
           ...
           role="listitem">
          <div class="floating-contact__item-icon">${c.icon}</div>
          <div class="floating-contact__item-text">
            <span class="floating-contact__item-label">${c.label}</span>
            <span class="floating-contact__item-sub">${c.sub}</span>
          </div>
          ${ARROW_ICON}
        </a>
      `).join('')}
